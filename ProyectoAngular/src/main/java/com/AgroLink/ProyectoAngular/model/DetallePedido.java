...
public class DetallePedido {
    ...
    public EstadoDetalleEnum getEstadoDetalle() { return estadoDetalle; }
    public void setEstadoDetalle(EstadoDetalleEnum estadoDetalle) { this.estadoDetalle = estadoDetalle; }
}
