...
public class Cultivo {
    ...
    public Double getAreaTerrenoHa() {
        return areaTerrenoHa;
    }

    public void setAreaTerrenoHa(Double areaTerrenoHa) {
        this.areaTerrenoHa = areaTerrenoHa;
    }
    ...
    public EstadoCultivoEnum getEstado() {
        return estado;
    }

    public void setEstado(EstadoCultivoEnum estado) {
        this.estado = estado;
    }
