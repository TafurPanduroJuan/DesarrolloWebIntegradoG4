...
public class EventoProduccion {
    ...
    public Double getImpactoEstimadoPct() {
        return impactoEstimadoPct;
    }
    public void setImpactoEstimadoPct(Double impactoEstimadoPct) {
        this.impactoEstimadoPct = impactoEstimadoPct;
    }
